...
/* branch data */
insert into
  branch (branch_id, name, address, city, state, Zip_Code)
values
  (
    null,
    'Headquarters',
...
/* product data */
insert into
  product (product_cd, name, product_type_cd, date_offered)
values
  (
    'CHK',
    'checking account',
...
insert into
  individual (cust_id, First_Name, Last_Name, birth_date)
select
  cust_id,
  'James',
  'Hadley',
